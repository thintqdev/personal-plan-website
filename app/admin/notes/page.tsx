...
// Folder tree demo structure (mutable)
    ...
    children: [
      {
        ...
        content: `
          ...
          <table>
            ...
            <tbody>
              <tr><td>Ăn uống</td><td>3.000.000đ</td></tr>
              <tr><td>Giải trí</td><td>1.200.000đ</td></tr>
              <tr><td>Di chuyển</td><td>800.000đ</td></tr>
            </tbody>
          </table>
          <ul>
            <li>Tiết kiệm: 2.000.000đ</li>
            <li>Đầu tư: 1.000.000đ</li>
          </ul>
        `,
      ...
      },
      {
        ...
        content: `
          <ol>
            <li>Đặt mục tiêu tiết kiệm 20% thu nhập mỗi tháng</li>
            <li>Chia khoản tiết kiệm thành các mục tiêu nhỏ</li>
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        content: `
          <h4>Buổi họp ngày 20/8</h4>
          <ul>
            <li>Thảo luận về dự án mới</li>
            <li>Phân công nhiệm vụ</li>
            <li>Thống nhất deadline</li>
          </ul>
        `,
...
export default function AdminNotesPage() {
  ...
  const handleAddFolder = () => {
    ...
    setNotesTree([
      { id: newId, label: newFolderName.trim(), children: [] },
      ...notesTree,
    ]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100 flex">
      ...
      <main className="basis-3/4 flex flex-col px-0 max-w-full min-h-screen h-full">
        {selected ? (
          (() => {
            const note = allNotes.find((n: any) => n.id === selected);
            if (!note) return null;
            return (
